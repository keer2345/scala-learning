...
object FormatAbsAndFactorial {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(formatResult("absolute", -41, abs))
...
object AnonymousFunctions {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(formatResult("increment6", 7, x => {
      val r = x + 1
      r
    }))
  }
...
object PolymorphicFunctions {
  ...
  */
  ...
  def main(args: Array[String]): Unit = {
    println(findFirst(Array(1, 3, 5, 7, 9), (x: Int) => x == 7))
    println(isSorted(Array(1, 2, 3, 4, 5, 6, 7), (x: Int, y: Int) => x > y))
  }
}
